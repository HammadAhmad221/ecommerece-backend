...
//     // Merge localStorage cart with the customer's existing cart
//     const localCart = req.body.cartDetails;
//     if (localCart && localCart.length > 0) {
//       localCart.forEach((localCartItem) => {
//         const existingProduct = customer.cartDetails.find(
//           (item) => item._id === localCartItem._id
//         );

//         if (existingProduct) {
//           // Update the quantity if the product already exists in the cart
//           existingProduct.quantity += localCartItem.quantity;
//         } else {
//           // Add new product to the cart
//           customer.cartDetails.push(localCartItem);
//         }
//       });
